...
Planner::Planner(string lower_bounds_str, string base_lower_bounds_str,
                 string upper_bounds_str, string base_upper_bounds_str)
    : PlannerBase(lower_bounds_str, base_lower_bounds_str, upper_bounds_str,
...
bool Planner::RunStep(Solver* solver, World* world, Logger* logger) {
  ...
  logi << "[Planner::RunStep] Time spent in ExecuteAction(): " << execute_time
       << endl;
